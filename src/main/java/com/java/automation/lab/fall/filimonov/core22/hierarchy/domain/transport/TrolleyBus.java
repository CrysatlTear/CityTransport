...
import com.java.automation.lab.fall.filimonov.core22.hierarchy.factory.driverFact.TrolleyBusFactory;
...
public class TrolleyBus extends CityTransport implements Comparable<TrolleyBus>, Serializable {

    public TrolleyBus() throws BusDriverInvalidAgeException {}

    public TrolleyBus(int id, int price, int maxSpeed, TransportSize size, String modelName, Engine engine,
    ...
    TrolleyBusDriver driver = TrolleyBusFactory.createProfesionalTrolleyBusDriver("Vasya", 40);

    public void driverInfo(TrolleyBusDriver x){
        x.showInfo();
        x.showDriverLicence();
    }

    public void driverCheckLicence(TrolleyBusDriver x){
    ...
    public void driverIn() {
        System.out.println("Driver " + driver.getName() + " in trolleybus !!!");
    }
    ...
    public void printInfo() {
        System.out.println("TrolleyBus info : TrolleyBus model - " + this.getModelName() + "; type - " + this.getSize()+
    ...
    public boolean equals(Object other){
        ...
        TrolleyBus that = (TrolleyBus) other;
    ...
    public TrolleyBusDriver getDriver() {
        return driver;
    }

    public void setDriver(TrolleyBusDriver driver) {
        this.driver = driver;
    }

    @Override
    public int compareTo(TrolleyBus o) {
